...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        for (String pattern : combos) {
            ...
            if (charOccurrencePositions.containsKey(firstCharInCombo)) {
                for (Integer firstOccurrenceIndex : charOccurrencePositions.get(firstCharInCombo)) {
                    if (charOccurrencePositions.containsKey(secondCharInCombo)) {
                        int secondLeftmostIndex = leftmostBS(
                                charOccurrencePositions.get(secondCharInCombo),
                                secondOccurrenceIndex -> secondOccurrenceIndex > firstOccurrenceIndex);
                        if (secondLeftmostIndex != -1)
                            cnt += charOccurrencePositions.get(secondCharInCombo).size() - secondLeftmostIndex;
                    }
